/** Real ISO 3166-1 alpha-2 country codes + English short names — used to
 *  populate real Country dropdowns (Birth Place, Current Location). Static
 *  reference data, not fetched, since the list changes essentially never. */

...
export function MatchScreen() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center overflow-hidden bg-midnight px-6 text-center text-white">
      ...
      >
        {compatibility !== null
          ? `You and ${profile.name.split(' ')[0]} liked each other and share a ${compatibility}% compatibility score.`
          : `You and ${profile.name.split(' ')[0]} liked each other. Your Match is mutual.`}
      </motion.p>

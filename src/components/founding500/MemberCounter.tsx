...
export function MemberCounter({ config }: { config: Founding500Config }) {
  ...
  return (
    <div className="mx-auto w-full max-w-md rounded-[1.35rem] border border-white/10 bg-[#071126]/45 px-5 py-5 text-center shadow-[inset_0_1px_0_rgba(255,255,255,.04),0_20px_60px_rgba(2,7,20,.16)] backdrop-blur-md sm:px-8">
